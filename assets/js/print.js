...
function buildPrintView(chapterId) {
  ...
  const questionsHtml = chapter.questionOrder
    .map((qid, idx) => {
      ...
      if (question.type === "mcq") {
        ...
        optionsHtml =
          '<li class="print-option"><span class="print-marker"></span>' +
          esc(t("common.trueLabel")) +
          "</li>" +
          '<li class="print-option"><span class="print-marker"></span>' +
          esc(t("common.falseLabel")) +
          "</li>";
      }
      return (
        '<li class="print-question">' +
        "<div><strong>" +
        esc(t("print.question", { n: idx + 1 })) +
        "</strong></div>" +
  ...
  root.innerHTML =
    ...
    esc(t("print.name")) +
    ' <span class="print-fill-line"></span></span>' +
    '<span class="print-field">' +
    esc(t("print.date")) +
    ' <span class="print-fill-line"></span></span>' +
    '<span class="print-field">' +
    esc(t("print.score")) +
    ' <span class="print-fill-line short"></span> ' +
    esc(t("print.ofTotal", { total: chapter.questionOrder.length })) +
    "</span>" +
    "</div>" +
    '<ol class="print-question-list">' +
    questionsHtml +
    "</ol>" +
    "</section>";
}
